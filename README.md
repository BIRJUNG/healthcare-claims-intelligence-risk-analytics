...
[Live GitHub Pages App](https://mohammed-ghanim-siddiqui.github.io/healthcare-claims-intelligence-risk-analytics/) | [GitHub Repository](https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics) | [Deployment Workflow](https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics/actions/workflows/deploy-pages.yml)

![Deploy healthcare claims intelligence dashboard](https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics/actions/workflows/deploy-pages.yml/badge.svg)
...
| Resource | Link |
|---|---|
| Live app | https://mohammed-ghanim-siddiqui.github.io/healthcare-claims-intelligence-risk-analytics/ |
| Repository | https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics |
| Deployment workflow | https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics/actions/workflows/deploy-pages.yml |
...
```powershell
git clone https://github.com/MOHAMMED-GHANIM-SIDDIQUI/healthcare-claims-intelligence-risk-analytics.git
...
```text
https://mohammed-ghanim-siddiqui.github.io/healthcare-claims-intelligence-risk-analytics/
```
